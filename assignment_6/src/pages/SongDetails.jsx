  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-gradient-to-b from-primary/20 to-transparent dark:from-primary/10 rounded-lg p-8 mb-8"
      >
        <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
          ...
          <div className="flex-1">
            ...
            <motion.button
              ...
              className="bg-primary hover:bg-green-600 text-white px-8 py-4 rounded-full font-semibold text-lg flex items-center gap-3 shadow-lg"
            >
      ...
      >
        <div className="lg:col-span-2 bg-white dark:bg-lightDark rounded-lg p-6">
          ...
          <div className="text-gray-700 dark:text-gray-300 leading-relaxed">
            <p className="mb-4">
              "{song.title}" is a track from the album "{song.album}" by {song.artist}.
            </p>
            <p>
              Released in {song.releaseDate}, this {song.genre.toLowerCase()} song has become
              a favorite among music lovers worldwide.
            </p>
          </div>
        </div>
